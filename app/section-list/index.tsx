    ...
    <ThemedView>
      <ThemedCard>
        <SectionList
          ...
          renderItem={({ item }) => (
            <ThemedText className="dark:text-white">{item}</ThemedText>
          )}
          ListHeaderComponent={() => (
            <ThemedText type="h1" className="dark:text-white font-bold mb-3 ">
              personajes
            </ThemedText>
          )}
          renderSectionHeader={({ section }) => (
            <ThemedText
              className="dark:text-white bg-light-background dark:bg-dark-background p-2 rounded"
              type="h1"
            >
              {section.title}
            </ThemedText>
          ...
          ListFooterComponent={() => (
            <ThemedText
              type="h1"
              className="dark:text-white font-bold mb-10 bg-light-background dark:bg-dark-background p-2 rounded"
            >
